                                ...
                                <center>
                                    ...
                                    @csrf    
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                <input type="text" class="form-control" name="title" id="inputEmail3" value="{{ $subcategory->title }}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="inputEmail3" class="col-sm-2 control-label">Fontawsome</label>
                                                <div class="col-sm-10">
                                                <input type="text" class="form-control" name="fontawsome" id="inputEmail3" value="{{ $subcategory->fontawsome }}">
