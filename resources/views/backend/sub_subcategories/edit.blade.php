                        ...
                        <div class="panel-body">
                            <div class="row">
                                <center>
                                    ...
                                    <div class="col-md-8">
                                            <form class="form-horizontal" action="{{ route('sub_subcategories.update',$sub_subcategory->id) }}" method="post">
                                                @csrf    
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                 <select class="form-control form-select-options" name="category_id" id="category">
                                                    ...
                                                    <option value="{{ $category->id }}" {{ ( $category->id == $sub_subcategory->category_id) ? 'selected' : '' }}> {{ $category->title }} </option>
                                                    @endforeach
                                                 </select>
                                                </div>
                                            </div>
                                            <div class="form-group" id="subcategory_div" style="display:block">
                                                ...
                                                <div class="col-sm-10">
                                                 <select class="form-control form-select-options" id="subcategory_options" name="subcategory_id">
                                                    ...
                                                    <option value="{{ $subcategory->id }}" {{ ( $subcategory->id == $sub_subcategory->subcategory_id) ? 'selected' : '' }}> {{ $subcategory->title }} </option>
                                                    @endforeach
                                                 </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                <input type="text" class="form-control" name="title" id="inputEmail3" value="{{ $sub_subcategory->title }}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="inputEmail3" class="col-sm-2 control-label">Fontawsome</label>
                                                <div class="col-sm-10">
                                                <input type="text" class="form-control" name="fontawsome" id="inputEmail3" value="{{ $sub_subcategory->fontawsome }}">
