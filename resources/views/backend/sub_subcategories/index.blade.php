...
<div class="page-inner">
        ...
        <div class="page-title">
            <h3 class="breadcrumb-header">Sub_subcategories</h3>
        </div>
        <div id="main-wrapper">
            <div class="row">
                <div class="col-md-12">
                                    ...
                                    <table id="example" class="display table table-data-width">
                                            ...
                                            <tbody>
                                                @foreach ($sub_subcategories as $sub_subcategory)
                                                    <tr>
                                                        <td>{{ $sub_subcategory->category->title }}</td>
                                                        <td>{{ $sub_subcategory->subcategory->title }}</td>
                                                        <td>{{ $sub_subcategory->title }}</td>
                                                        <td>
                                                        <form action="{{ route('sub_subcategories.destroy',$sub_subcategory->id) }}" method="POST"> 
                                                        @csrf
                                                        <a href="{{ route('sub_subcategories.edit',$sub_subcategory->id) }}" type="button" class="btn btn-info btn-rounded">Update</a>
