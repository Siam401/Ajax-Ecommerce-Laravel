                        ...
                        <div class="col-md-4 col-login-box-alt">
                            <div class="panel panel-white login-box">
                                <div class="panel-body">
                                    <a href="{{ route('view.home') }}" class="logo-name">Flipmart</a>
                                    <p class="m-t-md">Please login into your account</p>
                                    <form class="m-t-md" method="POST" action="{{ route('login') }}" aria-label="{{ __('Login') }}">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            <input type="password" name="password" class="password form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="Password" name="password" required>
                                    ...
                                    <a href="{{ route('register') }}" class="btn btn-default btn-block metro-reg-button">Create an account</a>
                                        <a href="{{ route('password.request') }}" class="display-block text-muted">Forgot Password?</a>
                                    </form>
                                </div>
                            </div>
                        </div>
